...
with st.container():
    ...
    if selected == "Home":
        ...
        <img src="https://blogpictures.99.co/pembangkit-listrik-di-indonesia-header.jpg" width="500" height="300">
        ...
        df = pd.read_csv(
            'https://raw.githubusercontent.com/MeAdila/streamlit/main/Electric_Production.csv')
